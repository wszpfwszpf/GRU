...
def main():
    ...
    train_dataset = torchvision.datasets.CIFAR10('data/cifar10-data', train=True, transform=transform)
    test_dataset = torchvision.datasets.CIFAR10('data/cifar10-data', train=False,
                                                transform=torchvision.transforms.Compose([
                                                    torchvision.transforms.ToTensor(),
                                                ]))
    dataloaders_dict = {
...
if __name__ == '__main__':
    ...
    train_dataset = torchvision.datasets.CIFAR10('data/cifar10-data', train=True, transform=transform, download=True)
    test_dataset = torchvision.datasets.CIFAR10('data/cifar10-data', train=False,
                                                transform=torchvision.transforms.Compose([
                                                    torchvision.transforms.ToTensor(),
                                                ]))
