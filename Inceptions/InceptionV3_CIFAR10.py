...
class InceptionD(nn.Module):
    ...
    def __init__(self, in_channels, out_channels=64, add_channels=0):
        ...
        self.branch5x5_3 = BasicConv2d(178 // 2 + add_channels // 2, 178 // 2 + add_channels // 2, kernel_size=3,
                                       stride=2)
...
class Inceptionv3(nn.Module):
    def __init__(self, num_classes=10, aux_logits=True):
        ...
        self.fc = nn.Conv2d(1024, num_classes, kernel_size=(1, 1), stride=(1, 1))
...
class InceptionAux(nn.Module):
    ...
    def __init__(self, in_channels, num_classes=10):
        ...
        self.avgpool = nn.AdaptiveAvgPool2d((1, 1))
        self.fc = nn.Conv2d(in_channels, num_classes, kernel_size=(1, 1), stride=(1, 1))
